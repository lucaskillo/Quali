        ...
        <div class="page-header">
            <div class="row">
                <div class="col-md-4 text-xs-center text-md-left text-nowrap">
                    <h1><i class="page-header-icon ion-ios-calendar-outline"></i>Editar Configuração</h1>
                </div>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        {!! Form::model($website_general,[
                                   'route' => ['website_generals.update', 'website_generals' => $website_general->id]
